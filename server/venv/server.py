...
"""@app.route('/engine/<pdf_path>')
def recursiveFunc(pdf_path):
    filename = "%s%s" % (root_location, pdf_path)
    print(filename)
    print(root_location, pdf_path)
    if filename != None:
        doc = pdf_reader(filename, spacy.blank('en'))._.page(1)
        d = recursiveExtract(doc, 0, 0, {}, '')
        if len(d) != 0:
            d['name'] = pdf_path
        return d"""
...
# print(recursiveFunc(doc, i=0, counter=0, d={}, s=''))
# d = recursiveFunc(doc, i=0, counter=0, d={}, s='')
# print(len(doc.text)-3)

# patterns = []
# ruler = nlp.add_pipe("entity_ruler")
# for i in d:
#     patterns.append({"label": "VARIABLE",
#                      "pattern": str(i)})
# for k in d:
#     for i in d[k]:
#         patterns.append({"label": "SUB-ARTICLE",
#                          "pattern": str(i)})

# ruler.add_patterns(patterns)

# doc = pdf_reader(
#     "/Users/mohammadannan/Desktop/Dataset/US20220164895A1.pdf", nlp)
